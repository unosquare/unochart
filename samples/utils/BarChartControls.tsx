  ...
  return (
    <div>
      ...
      <div className="p-4 bg-gray-50 rounded-lg">
        <label htmlFor="barCategoryGap" className="block text-sm font-medium text-gray-700 mb-1">Bar Category Gap</label>
        <input
          id="barCategoryGap"
        ...
        <label htmlFor="barGap" className="block text-sm font-medium text-gray-700 mt-4">Bar Gap</label>
        <input
          id="barGap"
        ...
        <label htmlFor="layout" className="block text-sm font-medium text-gray-700 mt-4">Layout</label>
        <select
          id="layout"
          value={layout}
