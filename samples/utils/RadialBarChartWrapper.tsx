...
interface RadialBarChartWrapperProps {
    data?: typeof MOCK_DATA;
    initialWidth?: number;
    initialHeight?: number;
    initialInnerRadius?: string;
    initialOuterRadius?: string;
}
...
export default function RadialBarChartWrapper({
    ...
    initialWidth = 730,
    initialHeight = 250,
    initialInnerRadius = '10%',
    initialOuterRadius = '80%',
}: RadialBarChartWrapperProps) {
    const [width, setWidth] = useState(initialWidth);
    const [height, setHeight] = useState(initialHeight);
    const [innerRadius, setInnerRadius] = useState(initialInnerRadius);
